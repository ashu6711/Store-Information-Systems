...
public class MergeSorter
{
   ...
   */
   ...
   {  
      ...
      String[][] first = new String[a.length / 2][6];          
      String[][] second = new String[a.length - first.length][6];
   ...
   */
   ...
   {  
      ...
      {  
         if (Integer.parseInt(first[iFirst][5]) < Integer.parseInt(second[iSecond][5]))
         {  
            a[j] = first[iFirst];
            iFirst++;
         }
